		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#exerciciosfiorijokenpo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exerciciosfiorijokenpo-display": {
								"semanticObject": "exerciciosfiorijokenpo",
								"action": "display",
								"description": "Uma aplicação SAP FIORI para jogar Jokenpô!",
								"title": "Pedra, Papel ou Tesoura!",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exercicios.fiori.jokenpo",
									"url": sap.ui.require.toUrl("exercicios/fiori/jokenpo")
								}
							}
						}
					}
